...
<template>
    ...
    <form method="POST" id="checkout" class="w-full max-w-xl mx-auto bg-white rounded shadow-xl relative py-4">
        ...
        <div class="py-2 px-4 md:px-8">php
            ...
            <div class="mt-4">
                <div class="w-full">
                    <button @click.prevent="pushsubscribe" class="h-auto lg:h-12 text-xs py-1 lg:py-2 px-2 lg-px-4 text-white font-light tracking-wider bg-gray-900 rounded-lg uppercase w-full focus:outline-none focus:shadow-outline" type="submit">Pay</button>
                </div>
            </div>
        </div>
    </form>
